...
[id="rn-3-9023"]
== RHSA-2026:28571 - {productname} 3.9.23 release

Issued 2026-6-23

{productname} release 3.9.23 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2026:28571[RHSA-2026:28571] advisory.
