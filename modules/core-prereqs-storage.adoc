...
Local storage and Network File System:: {productname} can work with local storage and Network File Systems (NFS), however this should only be used for proof of concept or test setups, as the durability of the binary blobs cannot be guaranteed.
