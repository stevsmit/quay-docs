...
[id="rn-3-12-19"]
== RHSA-2026:30076 - {productname} 3.12.19 release

Issued 2026-06-25

{productname} release 3.12.19 is now available with Clair {clairproductminv}. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2026:30076[RHSA-2026:30076] advisory.
